...
import ro.fasttrackit.hotelroomsapihomeworkc8.model.entity.RoomFacilities;
...
public class RoomDao {
    ...
    public List<Room> getAll(RoomFilters filters){
        ...
        CriteriaQuery<Room> query = criteria.select(rootRoom).where(whereClause.toArray(new Predicate[]{}));
